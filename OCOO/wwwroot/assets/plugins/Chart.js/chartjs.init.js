$(document).ready(function () {
    ...
    data.ChartData.forEach((group, groupIndex) => {
        group.Months.forEach((month, monthIndex) => {
            ...
            if ((monthIndex === Math.floor(group.Months.length / 2))) {
                labels.push((monthIndex === Math.floor(group.Months.length / 2)) ? '\n\n\n\n\n\n\n\n\n\n\n' + group.Year : '');
            }
            else {
                labels.push(month);
            }
    ...
    var dataset = {
        ...
        /* spanGaps: true,*/
        data: Array.from({ length: labels.length }, () => Math.floor(Math.random() * 50) + Math.random()),
    ...
    var ctx1 = document.getElementById("chart8").getContext("2d");
    var data1 = {
        ...
        datasets: [
            ...
            },
            {
                ...
                pointHighlightFill: "#fff",
                pointHighlightStroke: "#009efb",
                data: [0, 59, 80, 65, 10, 55, 40, 40, 19, 86, 27, 90]
            }
    ...
    var chart8 = new Chart(ctx1).LineAlt(data1, {
        scaleShowGridLines: true,
        scaleGridLineColor: "rgba(0,0,0,.005)",
        scaleGridLineWidth: 0,
        scaleShowHorizontalLines: true,
    ...
    var ctx1 = document.getElementById("chart10").getContext("2d");
    var data1 = {
        labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oc", "Nov", "Dec"],
        datasets: [
            {
                label: "My Second dataset",
                fillColor: "rgba(243,245,246,0.9)",
                ...
                pointHighlightFill: "#fff",
                pointHighlightStroke: "rgba(243,245,246,0.9)",
                data: [28, 48, 40, 19, 86, 27, 90, 100, 200, 300, 400, 500]
            },
            {
                label: "My First dataset",
                fillColor: "#009efb",
    ...
    var chart10 = new Chart(ctx1).LineAlt(data1, {
        scaleShowGridLines: true,
        scaleGridLineColor: "rgba(0,0,0,.005)",
        scaleGridLineWidth: 0,
        scaleShowHorizontalLines: true,
    ...
    var chart9 = new Chart(ctx1).LineAlt(data1, {
        scaleShowGridLines: true,
        scaleGridLineColor: "rgba(0,0,0,.005)",
        scaleGridLineWidth: 0,
        scaleShowHorizontalLines: true,
    ...
    var ctx1 = document.getElementById("chart11").getContext("2d");
    var data1 = {
        labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oc", "Nov", "Dec"],
        datasets: [
            {
    ...
    var chart11 = new Chart(ctx1).LineAlt(data1, {
        scaleShowGridLines: true,
        scaleGridLineColor: "rgba(0,0,0,.005)",
        scaleGridLineWidth: 0,
        scaleShowHorizontalLines: true,
